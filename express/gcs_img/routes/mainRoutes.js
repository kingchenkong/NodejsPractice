...
//
var images = require('../library/images');
...
//   console.log('req.files: ' + req.public);
...
//   res.end();
// });
router.post('/uploadFile', images.multer.single('image'), images.sendUploadToGCS, (req, res, next) => {
  let data = req.body;
